...
# os.environ["PYPPETEER_CHROME_EXECUTABLE"] = chrome_path

try:
    # 先获取 PNG 二进制数据
    from langchain_core.runnables.graph import MermaidDrawMethod
    # 需要修改源码
    # 在/root/miniconda3/envs/rag-langchain-linux-02/lib/python3.10/site-packages/langchain_core/runnables/graph_mermaid.py的Line325
    # 添加参数：headless=True, executablePath="/usr/bin/google-chrome-stable", args=['--no-sandbox']
    # browser = await launch( headless=True, executablePath="/usr/bin/google-chrome-stable", args=['--no-sandbox'] )
    ...
    print("已保存为：02-AdaptiveRAG-Graph.png")
